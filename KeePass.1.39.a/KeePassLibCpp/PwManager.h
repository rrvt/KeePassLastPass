...
#include <string>
#include <vector>
#include <boost/static_assert.hpp>                        // Added for boost changes
#include <boost/scoped_ptr.hpp>                           // Added for boost changes
...
#ifndef _UNICODE
#define PWM_VERSION_STR  _T("1.39.a")
#else
#define PWM_VERSION_STR  _T("1.39.a Unicode")
#endif
#define PWM_VERSION_DW   0x01270000
#define PWM_VERSION_QW   0x0001002700000000ULL
...
#define PWMKEY_AUTOTYPENORMDASHES   _T("KeeAutoTypeNormDashes")
