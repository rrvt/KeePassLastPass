...
#include <string>
#include <vector>
#include <boost/static_assert.hpp>                                      // rrvt -- Added for boost changes
#include <boost/scoped_ptr.hpp>                                         // rrvt -- Added for boost changes
...
#ifndef _UNICODE
#define PWM_VERSION_STR  _T("1.41.1")
#else
#define PWM_VERSION_STR  _T("1.41 Unicode")
#endif
#define PWM_VERSION_DW   0x01290000
#define PWM_VERSION_QW   (UINT64) 0x0001002900000000ULL
