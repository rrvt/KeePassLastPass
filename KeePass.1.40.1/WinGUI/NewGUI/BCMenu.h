...
public:
  ...
  static int GetMenuDrawMode(void);                       // rrvt c++2020   BCMenu::
  static BOOL GetSelectDisableMode(void);                 // rrvt c++2020   BCMenu::
...
protected:
  ...
  BCMenuData *FindMenuItem(UINT nID);          // rrvt c++2020    BCMenu::
  ...
  void InitializeMenuList(int value);                   // rrvt c++2020   BCMenu::
  void DeleteMenuList(void);                            // rrvt c++2020   BCMenu::
  BCMenuData *FindMenuList(UINT nID);                   // rrvt c++2020   BCMenu::
